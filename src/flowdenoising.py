...
def OF_filter_along_Y(vol, kernel, l, w, get_flow):
    global __percent__
...
def OF_filter_along_X(vol, kernel, l, w, get_flow):
    global __percent__
...
def OF_filter(vol, kernels, l, w, get_flow):
    OF_filter_along_Z(vol, kernels[0], l, w, get_flow)
    vol[...] = filtered_vol[...]
    OF_filter_along_Y(vol, kernels[1], l, w, get_flow)
    vol[...] = filtered_vol[...]
    OF_filter_along_X(vol, kernels[2], l, w, get_flow)
...
if __name__ == "__main__":    
    ...
    if args.no_OF:
        ...
        OF_filter(vol, kernels, l, w, get_flow)
